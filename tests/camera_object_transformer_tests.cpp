...
TEST(camer_object_transformer, position)
{
    ...
    const auto tranformer = game::CameraObjectTransformer{position, camera};

    ASSERT_EQ(tranformer.position(), position);
}

TEST(camera_object_transformer, update_camera_did_not_move)
{
    auto camera = game::Camera{{0.f, 2.f, 20.f},
                               {0.f, 0.f, 0.f},
                               {0.f, 1.f, 0.f},
    ...
    auto tranformer = game::CameraObjectTransformer{camera.position(), camera};
...
TEST(camera_object_transformer, update_camera_did_move)
{
    auto camera = game::Camera{{0.f, 2.f, 20.f},
                               {0.f, 0.f, 0.f},
                               {0.f, 1.f, 0.f},
    ...
    const auto expected = game::Vector3{1.f, 2.f, 18.f};
